...
(()=>{
  liberator.plugins.ebith = {
    log: (msg) => {
      let obj = {};
      obj[(new Date()).toLocaleString()] = msg;
      io.File('~/.vimperator.log').write(JSON.stringify(obj) + '\n', '>>');
    },
    ...
    // document.createElement('a') を document.createElementNS('http://www.w3.org/1999/xhtml', 'a') に差し替えておく必要がある
    axios: require('axios'),
  }
})();

},{"axios":2,"moment":19}],2:[function(require,module,exports){
...
module.exports = (
  ...
  (function standardBrowserEnv() {
    ...
    var urlParsingNode = document.createElementNS('http://www.w3.org/1999/xhtml', 'a');
    var originURL;
